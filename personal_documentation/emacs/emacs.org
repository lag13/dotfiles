...
- Now that I've finally gotten fairly proficient in one particular language
  (golang) I think I should sit down and really think about what things I
  want when editing a programming language. I want a better workflow that
  can be used consistantly across different languages. That workflow will
  probably be different for translated languages than compiled but some
  stuff should still hold true.
