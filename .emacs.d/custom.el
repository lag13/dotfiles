(custom-set-variables
 ...
 '(highlight-symbol-colors
   '("#3c6f408d329d" "#0c4a45f64ce3" "#486e33913532" "#1fac3bea568d"
     "#2ec943ac3324" "#449935a7314d" "#0b04411b5986"))
 ...
 '(hl-todo-keyword-faces
   '(("HOLD" . "#c0c530") ("TODO" . "#feacd0") ("NEXT" . "#b6a0ff")
     ("THEM" . "#f78fe7") ("PROG" . "#00d3d0") ("OKAY" . "#4ae2f0")
     ("DONT" . "#70b900") ("FAIL" . "#ff8059") ("BUG" . "#ff8059")
     ("DONE" . "#44bc44") ("NOTE" . "#d3b55f") ("KLUDGE" . "#d0bc00")
     ("HACK" . "#d0bc00") ("TEMP" . "#ffcccc") ("FIXME" . "#ff9077")
     ("XXX+" . "#ef8b50") ("REVIEW" . "#6ae4b9")
     ("DEPRECATED" . "#bfd9ff")))
 ...
 '(safe-local-variable-values
   '((org-archive-reversed-order . t)
     (org-archive-location
      . "~/src/github.com/lag13/second-brain/archive/archive.org::datetree/")
     (org-archive-location
      . "~/src/github.com/lag13/second-brain/archive/archive.org::")
     (org-archive-location
      . "~/src/github.com/lag13/second-brain/archive.org::")
     (org-archive-location
      . "~/src/github.com/lag13/second-brain/archive.org::* From %s")
     (org-default-notes-file
      . "~/src/github.com/lag13/second-brain/capture.org")
     ...
     (org-roam-db-location
      . "~/src/github.com/lag13/second-brain/org-roam.db")
 ...
 '(vc-annotate-color-map
   '((20 . "#cc6666") (40 . "#de935f") (60 . "#f0c674") (80 . "#b5bd68")
     (100 . "#8abeb7") (120 . "#81a2be") (140 . "#b294bb")
     (160 . "#cc6666") (180 . "#de935f") (200 . "#f0c674")
     (220 . "#b5bd68") (240 . "#8abeb7") (260 . "#81a2be")
     (280 . "#b294bb") (300 . "#cc6666") (320 . "#de935f")
 ...
 '(warning-suppress-types
   '((comp) (use-package) (use-package) (use-package) (use-package)))
 '(weechat-color-list
